...
srand(time(NULL));
Do programu nalezy do³aczyc pliki nag³ówkowe:
#include <stdlib.h>
#include <time.h>*/

/*Chcemy, zeby w sytuacji, gdy w jednej linii stoja dwa kó³ka,
komputer, o ile tylko sie da, dostawia³ trzecie kó³ko.
Podobnie chcemy, zeby komputer blokowa³ kó³kami pary
krzyzyków znajdujacych sie w jednej linii.
Pierwszenstwo ma oczywiscie uzupe³nianie par kó³ek.
Do uzupe³niania par bedzie s³uzy³a funkcja uzupe³nij,
która bedzie zwraca³a wartosc rózna od zera wtedy i tylko
wtedy, gdy uda sie jej uzupe³nic jakas pare.
Funkcja uzupe³nij bedzie mia³a dwa argumenty:
plansze,
znak, którego pary maja byc uzupe³niane kó³kami.*/
...
G³ówna czesc programu bedzie stanowi³a petla wykonujaca sie
...
Dopóki gra jest nierozstrzygnieta zmienna wynik bedzie mia³a
wartosc 0.
